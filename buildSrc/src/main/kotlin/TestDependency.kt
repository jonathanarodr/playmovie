object TestDependency {
    ...
    const val COMPOSE_JUNIT = "androidx.compose.ui:ui-test-junit4:${Version.Compose.CORE}"
    const val COMPOSE_PREVIEW = "androidx.compose.ui:ui-tooling:${Version.Compose.CORE}"
    const val COMPOSE_MANIFEST = "androidx.compose.ui:ui-test-manifest:${Version.Compose.CORE}"
